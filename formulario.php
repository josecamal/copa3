...
<output id="list"></output>
	...
	<td colspan="2"><input type="file"  id="files" name="imagen"/></td>
...
<?php
echo "<br><a href=registro.php class='btn btn-info btn-small'>Regresar al menu Principal</a>";  echo "<a href=registro.php?action=exit class='btn btn-danger btn-small'>Cerrar Sesion</a>";
