...
$resEmp = mysql_query("SELECT  nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta, foto FROM datos where procedencia='Esc. Educación y Patria' ORDER BY deporte ,categoria , genero") or die(mysql_error());
...
$pdf->ezText("<b>Esc. Educacion y Patria</b>\n",16);
