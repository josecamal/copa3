...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Ajedrez'AND procedencia ='Esc. Yermo y Parres' ORDER BY categoria , genero") or die(mysql_error());
