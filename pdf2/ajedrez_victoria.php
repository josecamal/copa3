...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Ajedrez'AND procedencia ='Esc. Victoria' ORDER BY categoria") or die(mysql_error());
