...
$resEmp = mysql_query("SELECT entrenador,  procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Basquetbol' ") or die(mysql_error());
$txttit = "informe de los entrenadores de Basquetbol\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los entrenadores de Basquetbol</b>\n",16);
