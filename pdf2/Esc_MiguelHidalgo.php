...
$resEmp = mysql_query("SELECT nombre, apellidos, categoria, deporte, rama, rango, cinta FROM  datos WHERE procedencia='Esc. Miguel Hidalgo' ORDER BY deporte ,categoria , genero") or die(mysql_error());
