...
$resEmp = mysql_query("SELECT procedencia, afiliacion, folio, nombre, deporte, categoria, rama FROM  datos WHERE procedencia='Esc. Hispano Mexicano' ") or die(mysql_error());
$txttit = "Informe de todos los usuarios\n";
$titles = array(

                         
'procedencia'=>'<b>Nombre del responsable</b>',
'afiliacion'=>'<b>Afiliacion</b>',
'folio'=>'<b>Folio</b>',
'nombre'=>'<b>Nombre</b>',
