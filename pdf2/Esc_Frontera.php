...
$resEmp = mysql_query("SELECT  nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta, foto FROM datos where procedencia='Esc. Frontera' ORDER BY deporte ,categoria , genero ") or die(mysql_error());
