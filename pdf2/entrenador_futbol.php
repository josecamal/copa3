...
$resEmp = mysql_query("SELECT entrenador,  procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Futbol' ") or die(mysql_error());
$txttit = "informe de los entrenadores de Futbol\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los entrenadores de Futbol</b>\n",16);
