...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Taekwondo'AND procedencia ='Esc. Miguel Hidalgo' ORDER BY categoria , genero") or die(mysql_error());
