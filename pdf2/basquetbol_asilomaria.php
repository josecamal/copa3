...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Basquetbol'AND procedencia ='Esc. Asilo Santa María' ORDER BY categoria , genero") or die(mysql_error());
...
$pdf->ezText("<b>Esc. Asilo Santa María</b>\n",16);
