...
$resEmp = mysql_query("SELECT nombre,apellidos,genero,procedencia, enfermedad, enfermedades FROM  datos WHERE procedencia ='Esc. Hidalgo '") or die(mysql_error());
...
$pdf->ezText("<b>Informe Medico General De La Esc.Hidalgo</b>\n",16);
