...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Ajedrez'AND procedencia ='Esc. Hispano Mexicano' ORDER BY categoria , genero") or die(mysql_error());
$txttit = "informe de los alumnos registrados de Ajedrez\n";
$titles = array(
