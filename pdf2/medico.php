...
$resEmp = mysql_query("SELECT nombre,apellidos,genero,procedencia, enfermedad, enfermedades FROM  datos ") or die(mysql_error());
...
$pdf->ezText("<b>Informe Medico General</b>\n",16);
