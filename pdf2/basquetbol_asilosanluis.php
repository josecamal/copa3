...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Basquetbol'AND procedencia ='Esc. Asilo San Luis' ORDER BY categoria , genero") or die(mysql_error());
