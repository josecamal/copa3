...
$resEmp = mysql_query("SELECT nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Futbol' ORDER BY categoria , genero") or die(mysql_error());
$txttit = "informe de los registros de futbol\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los alumnos registrados a futbol</b>\n",16);
