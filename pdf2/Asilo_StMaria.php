...
$resEmp = mysql_query("SELECT  nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta, foto FROM datos where procedencia='Esc. Asilo Santa María' ORDER BY deporte ,categoria , genero") or die(mysql_error());
...
$pdf->ezText("<b>Esc. Asilo Santa Maria</b>\n",16);
