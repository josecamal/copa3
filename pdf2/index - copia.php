...
mysql_select_db("registros",$conexion) or die(mysql_error());
         
$resEmp= "";
$titles= "";
$txttit="";
     
$resEmp = mysql_query("SELECT nombre_resp, apellidos_resp, nombre, apellidos, procedencia, deporte, categoria, rama, cinta FROM datos_responsable, datos_gral, datos_esc, datos_deporte") or die(mysql_error());
