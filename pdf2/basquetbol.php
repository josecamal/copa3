...
$resEmp = mysql_query("SELECT nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Basquetbol' ORDER BY categoria , genero") or die(mysql_error());
$txttit = "informe de los registros de Basquetbol\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los alumnos registrados a Basquetbol</b>\n",16);
