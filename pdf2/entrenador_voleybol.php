...
$resEmp = mysql_query("SELECT entrenador,  procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Voleibol' ") or die(mysql_error());
$txttit = "informe de los entrenadores de Voleybol\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los entrenadores de Voleybol</b>\n",16);
