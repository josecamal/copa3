...
$resEmp = mysql_query("SELECT nombre,apellidos,genero,procedencia, enfermedad, enfermedades FROM  datos WHERE procedencia ='Esc. Educación y Patria'") or die(mysql_error());
...
$pdf->ezText("<b>Informe Medico General De La Esc.Educación Y Patria</b>\n",16);
