...
$resEmp = mysql_query("SELECT entrenador,  procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Taekwondo' ") or die(mysql_error());
$txttit = "informe de los entrenadores de Takewndo\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los entrenadores de Takewndo</b>\n",16);
