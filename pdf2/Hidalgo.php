...
$resEmp = mysql_query("SELECT  nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta, foto FROM datos where procedencia='Esc. Hidalgo' ORDER BY deporte ,categoria , genero") or die(mysql_error());
...
$pdf->ezText("<b>Colegio Hidalgo</b>\n",16);
