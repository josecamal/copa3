...
$resEmp = mysql_query("SELECT nombre,apellidos,genero,procedencia, enfermedad, enfermedades FROM  datos WHERE procedencia ='Esc. Hispano Mexicano'") or die(mysql_error());
...
$pdf->ezText("<b>Informe Medico General De La Esc. Hispano Mexicano</b>\n",16);
