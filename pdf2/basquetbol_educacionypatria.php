...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Basquetbol'AND procedencia ='Esc. Educación y Patria' ORDER BY categoria , genero") or die(mysql_error());
$txttit = "informe de los alumnos registrados a Basquetbol\n";
$titles = array(
...
$pdf->ezText("<b>Esc. Educación y Patria</b>\n",16);
