...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Futbol'AND procedencia ='Esc. Guadalupe Victoria' ORDER BY categoria , genero") or die(mysql_error());
$txttit = "informe de los alumnos registrados a Futbol\n";
$titles = array(
