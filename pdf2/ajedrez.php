...
$resEmp = mysql_query("SELECT nombre, apellidos, procedencia, deporte, categoria, rama, rango, cinta FROM  datos WHERE deporte='Ajedrez' ORDER BY categoria , genero") or die(mysql_error());
$txttit = "informe de los registros de Ajedrez\n";
$titles = array(
...
$pdf->ezText("<b>Regitros de los alumnos registrados Ajedrez</b>\n",16);
