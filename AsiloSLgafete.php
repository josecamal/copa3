...
<head>
  ...
  <title>Ver Gafetes De Los Alumnos</title>
  <meta name="viewport" content="width=device-width , initial-scale=1.0">
...
echo "<tr>
   ...
   <th>edad</th><th bgcolor=>fecha De Nacimiento</th><th>Sexo</th><th>Escuela</th><th>Ver Gafete</th><th></th></tr>";
   /*los datos*/
  ...
  <td> 
    ...
    <a href=gafete.php?id=".$row['ID']." ><img src='gafete.jpg' alt='ver gafete' width='30' height='30' align='middle' class='icon' title='Ver Gafete'></a> 
      </div> </td>
