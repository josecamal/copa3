...
mysql_select_db("livecamp_registros") OR die ("errorde conexion a la abase de datos");
/*realizamos la consulta ala base de datos*/
$sql="select * from datos where procedencia ='Esc. Educación y Patria'";
