...
$resEmp = mysql_query("SELECT nombre,apellidos,procedencia, deporte, categoria, rama, rango, cinta,entrenador FROM  datos WHERE deporte ='Futbol'AND procedencia ='Esc. Asilo San Luis' ") or die(mysql_error());
$txttit = "informe de los entrenadores de Ajedrez\n";
$titles = array(

                         
'nombre'=>'<b>Nombre del Alumno</b>',
'apellidos'=>'<b>Apellidos del alumno',
...
'rama'=>'<b>Rama</b>',
'rango' => '<b>Rango</b>',
'entrenador'=>'<br>Nombre del entrenador</b>',
'cinta' => '<b>Cinta</b>',)
...
$pdf->ezText("<b>Regitros de los entrenadores de Ajedrez</b>\n",16);
